...
//========================================================================
// Three modules of the design are nothing but Gowin primitives:
//   src/sys_pll.v          an rPLL
//   src/hdmi/hdmi_serdes.v an rPLL, four OSER10s, four ELVDS_OBUFs
//   src/pk8000/pk8000_rom.v eight pROMs, generated by tools/bin2prom.py
...
//   IDIV_SEL 8, FBDIV_SEL 9 => clkout = clkin * 10 / 9 = 30 MHz from 27
...
//------------------------------------------------------------------------
// pk8000_rom - src/pk8000/pk8000_rom.v: 8192 x 16, registered, the
// image out of tang/rom/pk8000_v12.rom through mif.py binhex (little-
// endian words, as bin2prom.py packs them).
//------------------------------------------------------------------------
module pk8000_rom (
    ...
    parameter MEM_HEX = "build/mif/pk8000_rom.hex";
    reg [15:0] mem [0:8191];
    integer i;
    initial begin
